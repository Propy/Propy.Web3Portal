...
import { useStakerUnlockTime, useUnifiedWriteContract } from '../hooks';
...
const StakeEnterUnified = (props: PropsFromRedux & IStakeEnter) => {
                      ...
                      }
                      {
                        ...
                        <div style={{maxWidth: 350, marginLeft: 'auto', marginRight: 'auto'}}>
                          ...
                          <FloatingActionButton
                            className={classes.submitButton}
                            buttonColor="secondary"
                            disabled={isAwaitingWalletInteraction || isAwaitingPerformStakeTx || isSyncingStaking || new BigNumber(balanceDataPRO?.value ? balanceDataPRO?.value.toString() : 0).isLessThan(minimumRequiredPROAllowance ? minimumRequiredPROAllowance.toString() : 0)}
                            onClick={() => executePerformStakeTx()}
                      ...
                      }
                      {
                        ...
                        <div style={{width: '100%', display: 'flex', flexDirection: 'column'}}>
                          <FloatingActionButton
                            className={classes.submitButton}
                            buttonColor="secondary"
                            disabled={isAwaitingPerformUnstakeTx || isAwaitingWalletInteraction || (Number(stakerUnlockTime) * 1000 > new Date().getTime()) || isSyncingStaking}
...
export default StakeEnterUnified;