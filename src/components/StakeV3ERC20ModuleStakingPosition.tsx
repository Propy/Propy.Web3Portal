...
interface IStakeV3ERC20ModuleStakingPosition {
  onClick?: () => void;
  totalShares?: BigInt;
}
...
const StakeV3ERC20ModuleStakingPosition = (props: IStakeV3ERC20ModuleStakingPosition) => {
            ...
            {Number(moduleShares) > 0 &&
              <>
                ...
                <Typography className={[classes.buttonTitle, 'flex-center', 'space-between'].join(" ")} variant="subtitle2">
                  ...
                  <span className='flex-center' style={{marginLeft: '16px'}}>
                  {priceFormat(Number(utils.formatUnits(Number(stakedPRO ? stakedPRO : 0), 8)), 2, 'PRO', false, true)}
                  <Tooltip placement="top" title={`Represents PRO value staked in this module`}>
                    <HelpIcon className={'tooltip-helper-icon'} />
                  </Tooltip>
                  </span>
                </Typography>
...
export default StakeV3ERC20ModuleStakingPosition;