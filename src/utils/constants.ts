...
export const SUPERBRIDGE_ETHEREUM_TO_BASE_LINK = `https://superbridge.app/base?fromChainKey=eth&fromTokenAddress=${PRO_ETHEREUM_L1_ADDRESS}&toChainKey=base&toTokenAddress=${PRO_BASE_L2_ADDRESS}`;
export const SUPERBRIDGE_BASE_TO_ETHEREUM_LINK = `https://superbridge.app/base?fromChainKey=base&fromTokenAddress=${PRO_BASE_L2_ADDRESS}&toChainKey=eth&toTokenAddress=${PRO_ETHEREUM_L1_ADDRESS}`;
...
export const PROPY_KEY_REPOSSESSION_CONTRACT = process?.env?.REACT_APP_ENV === 'prod' ? "0x5ACD9Aa50B20b6E9F43c43c6Fbd81263D2C03b33" : "0x0bf7f00E4d888fa9F5c9ace465711fC6F0dD1D72"; // "0x0bf7f00E4d888fa9F5c9ace465711fC6F0dD1D72" for using the default testnet propykeys, "0xb7EC51CA03d0774e7B83595CD8653E67fB7778ab" for staking testnet propykeys
